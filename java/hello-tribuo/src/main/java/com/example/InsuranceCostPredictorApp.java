...
public class InsuranceCostPredictorApp
{
    ...
    public static void main(String[] args ) throws IOException {
        ...
        //Load data
        var insuranceHeaders = new String[]{"Age", "Gender", "BodyMassIndex", "Children", "Smoke", "Department", "PremiumInsurance"};
        var insuranceDataSource = csvLoader.loadDataSource(Paths.get("src/main/resources/insurance.csv"), "PremiumInsurance", insuranceHeaders);
       ...
       // LibLinearRegressionTrainer trainer = new LibLinearRegressionTrainer();
        //Option2 XGB
        // var trainer = new XGBoostRegressionTrainer(25);
        ...
        // model = trainer.train(trainingDataset);
        ...
        System.out.println("R-squared:" + score.r2(dimension0));
       ...
       //ArrayExample(numFeatures=6,output=(DIM-0,11881.9696),weight=1.0,features=[(Age, 55.0)(BodyMassIndex, 30.14), (Children, 2.0), (Department, 1.0), (Gender, 0.0), (Smoke, 0.0), ])
        ...
        System.out.println("Predicted price for "+ featureValues.toString() +" =>"+result);
